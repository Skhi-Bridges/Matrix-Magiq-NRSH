//! Service and ServiceFactory implementation for Nourish Chain.
//! Specialized wrapper over substrate service.

use std::{sync::Arc, time::Duration};

use nourish_runtime::{self, opaque::Block, RuntimeApi};
...
type FullClient = sc_service::TFullClient<
    Block,
    RuntimeApi,
    NativeElseWasmExecutor<nourish_runtime::Executor>,
>;
...
pub fn new_light(config: Configuration) -> Result<TaskManager, ServiceError> {
    ...
    let executor = NativeElseWasmExecutor::<nourish_runtime::Executor>::new(
        config.wasm_method,
        config.default_heap_pages,
        config.max_runtime_instances,
    );
...
pub trait RuntimeApiCollection:
    ...
    + frame_system_rpc_runtime_api::AccountNonceApi<Block, nourish_runtime::AccountId, nourish_runtime::Index>
    + pallet_transaction_payment_rpc_runtime_api::TransactionPaymentApi<Block, nourish_runtime::Balance>
    + substrate_frame_rpc_system::AccountNonceApi<Block, nourish_runtime::AccountId, nourish_runtime::Index>
{}
